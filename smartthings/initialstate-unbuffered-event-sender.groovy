/**
 * Originally obtained from https://github.com/davidsulpy/initialstate-smartapp
 * 
 * Setup instructions:
 *  1. Copy the code from unbuffered-event-sender.groovy
 ...
 *  7. Select "Create"
 *  8. Edit line 193 and replace YOUR_ACCESS_KEY with an access key from your Initial State account. Optionally, you can edit the bucket information above this line should you wish.
 *  9.  Select "Save"
...
def subscribeToEvents() {
	...
	if (actuators != null) {
		subscribe(actuators, "bpmvalue", genericHandler)
		subscribe(actuators, "spo2", genericHandler)
	}
	if (alarms != null) {
...
def installed() {
	...
	atomicState.bucketKey = "HomeMedical" //change if needed
	atomicState.bucketName = "HomeMedical" //change if wanted
